...
public class TipCalculatorController 
{
   ...
   private void calculateButtonPressed(ActionEvent event) 
   {
      try 
      {
         ...
         BigDecimal tip = amount.multiply(tipPercentage).divide(people, RoundingMode.HALF_UP);
         BigDecimal total = amount.add(tip.multiply(people)).divide(people, RoundingMode.HALF_UP);
